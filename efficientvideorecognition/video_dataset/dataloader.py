...
def setup_arg_parser(parser: argparse.ArgumentParser):
    parser.add_argument('--train_list_path', type=str, default=r"C:\Users\Administrator\Desktop\train.txt", 
                        help='path to training data list')
    parser.add_argument('--val_list_path', type=str,  default=r"C:\Users\Administrator\Desktop\val.txt", 
    ...
    parser.add_argument('--data_root', type=str, default= r'C:\Users\Administrator\Desktop\mymodel\KoNViD_1k_videos',
